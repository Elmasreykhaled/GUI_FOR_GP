    ...
    def new_test(self):
        ...
        try:
            ...
            if warning == QMessageBox.Yes:
                if len(national_id) == 14 and len(name) >= 2 and len(ray_path) >= 2:
                    ...
                    m = QMessageBox(self)
                    m.setWindowTitle("Result")
                    m.setText("Test , Here will be positive or negative")
                    m.exec_()
            ...
            m = QMessageBox(self)
            m.setWindowTitle("Error")
            m.setText("Error, please try again with other data")
            m.exec_()
